...
#define MQTT_HOST            "192.168.31.251" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
...
#define STA_SSID "xuhongYss"    // your AP/router SSID to config your device networking
#define STA_PASS "bkxz733633" // your AP/router password
