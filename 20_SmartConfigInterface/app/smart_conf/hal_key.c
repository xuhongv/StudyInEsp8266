...
* @copyright    Gizwits
*
* @note         闂佸搫鐗忛崕銈呪枍閵堝棛顩查柨鐕傛嫹.闂佸憡鐟禍娆戞嫻閻旂厧鐤惧Δ锕�鐏濋崢瀵哥棯椤撗冨幐婵炲棎鍨介幊鎾崇暆閿熶粙寮敓锟�
*               Gizwits Smart Cloud  for Smart Products
*               闂備礁澧介崑鎾舵暜绾锯�愁熆瑜忛崑娑㈡晸閸婄喐鐑︾紒浣圭懃椤曪綁鏁撴禒瀣哗缂佽埖顨嗙粙澶愵敇閻橀潧缍剕闁诲海鎳撻ˇ顖炲矗瀵垽鏌ゆ總澶夌凹婵狅拷娴滃懘鏌ゆ總澶夌敖闁轰胶婀╅梺姹囧灮閸犳劙鏁撻弬銈嗗
*               www.gizwits.com
*
***********************************************************/
    ...
    if(Key_Check == 1)
    {
        ...
        switch (Key_State)
        {
            ...
            case 2:
                ...
                {
                    Key_LongCheck++;
                    if(Key_LongCheck >= (PRESS_LONG_TIME / DEBOUNCE_TIME))    //闂傚偊鎷烽柟绋块閻︼拷3S (濠电偞鍨甸悧濠冩叏閿燂拷30MS * 100)
                    {
                        Key_LongCheck = 0;
                        Key_State = 3;
