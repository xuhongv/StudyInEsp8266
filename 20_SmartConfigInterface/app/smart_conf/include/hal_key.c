...
* @copyright    Gizwits
*
* @note         闁哄牏鍎ゅ▍銈嗙閿燂拷.闁告瑯浜欑拹鐔煎疾妤﹀灝鍘寸痪顓у厸濞嗐垽鎳撳畝锟介弫锟�
*               Gizwits Smart Cloud  for Smart Products
*               闂佸墽鍋撶敮纾″褏鍋涢敓鍊熸烦缁佹瑥顕ｉ敓浠嬪绩缁舵绋夐鐘靛綄|閻庣懓顦崣寮㈤柤濂変簼濠�浜呴柤濂変簽閺佺湩闁汇垻鍠愰敓鏂ゆ嫹
*               www.gizwits.com
*
***********************************************************/
#include "smart_conf/hal_key.h"
#include "mem.h"
    ...
    if(Key_Check == 1)
    {
        ...
        switch (Key_State)
        {
            ...
            case 2:
                ...
                {
                    Key_LongCheck++;
                    if(Key_LongCheck >= (PRESS_LONG_TIME / DEBOUNCE_TIME))    //闂傦拷閹稿骸鐦�3S (婵炴垵鐗婃慨锟�30MS * 100)
                    {
                        Key_LongCheck = 0;
                        Key_State = 3;
